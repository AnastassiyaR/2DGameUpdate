...
public class Sound {
	...
	Clip clip; // to open sound
	URL soundURL[] = new URL[30]; // store sounds
	FloatControl fc;
	int volumeScale = 3;
	float volume;
	
	public Sound() {
		// in wav format because java does not accept other ones
	...
	public void checkVolume() {
		switch(volumeScale) {
		case 0: volume = -80f; break; // 0%
		case 1: volume = -20f; break;
		case 2: volume = -12f; break;
		case 3: volume = -5f; break;
		case 4: volume = 1f; break;
		case 5: volume = 6f; break; // 100%
		}
		fc.setValue(volume);
	}
